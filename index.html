...
<html>
    ...
    <body>
        <nav class="navbar">
            ...
            <ul class="nav-links">
              <li class="nav-item"><a href="accomodation.html">Accomodation</a></li>
        ...
        ​
          ...
          <section>
              <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-2"></div>
                      <div class="col-md-4" id="img-standard">
                          <img src="assets/hotel-images/room1.jpg" alt="standard room" width="506" height="350">   
                      </div>
        ...
        ​
                      ...
                      <div class="col-md-4">
                          <img src="assets/hotel-images/room2.jpg" alt="Deluxe rooms" width="506" height="350">
                      </div>
                      <div class="col-md-2"></div>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col-md-2"></div>
                      <div class="col-md-4" id="img-presidential">
                        <img src="assets/hotel-images/room3.jpg" alt="Presidential suite" width="506" height="350" >
                      </div>
                      <div class="col-md-4" id="presidential" >
